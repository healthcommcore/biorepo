	...
	*/
	...
	$page_meta_boxes = array(
			...
			'name'=>array(
				...
				'Portfolio'=>array(
					...
					'portfolio-type'=>array(
						...
						'type'=> 'combobox',
						'options'=>array('0'=>'Portfolio', '1'=>'Filter Portfolio', '2'=>'jQuery Filter Portfolio', '3'=>'Carousel Portfolio'),
				...
				'Stunning-Text'=>array(
					'icon'=>array(
						'title'=> 'STUNNING ICON',
						'name'=> 'page-option-item-stunning-icon',
						'type'=> 'upload'),				
					'title'=>array(
						'title'=> 'TITLE',
					...
					'button-text'=>array(
						'title'=> 'BUTTON TEXT',
						'name'=> 'page-option-item-stunning-button-text',
						'type'=> 'inputtext',
						'default'=> 'Buy Now!'),	
					'button-link'=>array(
						'title'=> 'BUTTON LINK',
						'name'=> 'page-option-item-stunning-button-link',
						'type'=> 'inputtext'),
					'item-margin'=>array(
						'title'=> __('BOTTOM MARGIN', 'gdl_back_office'),
		...
		"Top Slider Type" => array(
			...
			'options'=>array('0'=>'No Slider', '1'=>'Nivo Slider', '2'=>'Flex Slider', '3'=>'Anything Slider', '4'=>'Layer Slider'),
			'type'=>'combobox',
			'hr'=>'none',
