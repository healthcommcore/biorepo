 ...
 */
 ...
 jQuery(document).ready(function(){
	...
	jQuery('.radio-image-wrapper input').change(function(){
		...
		if( jQuery(this).val() == 'post-right-sidebar' || jQuery(this).val() == 'right-sidebar'  ){
			panel_body.siblings('.gdl-default-post-left-sidebar').slideUp(function(){ jQuery(this).css('display','none'); });
			panel_body.siblings('.gdl-default-post-right-sidebar').slideDown();
		}else if( jQuery(this).val() == 'post-left-sidebar' || jQuery(this).val() == 'left-sidebar' ){
			panel_body.siblings('.gdl-default-post-right-sidebar').slideUp(function(){ jQuery(this).css('display','none'); });
			panel_body.siblings('.gdl-default-post-left-sidebar').slideDown();
		}else if( jQuery(this).val() == 'post-both-sidebar' || jQuery(this).val() == 'both-sidebar' ){
			panel_body.siblings('.gdl-default-post-left-sidebar').slideDown();
			panel_body.siblings('.gdl-default-post-right-sidebar').slideDown();
		}else if( jQuery(this).val() == 'post-no-sidebar' || jQuery(this).val() == 'no-sidebar' ){
			panel_body.siblings('.gdl-default-post-left-sidebar').slideUp(function(){ jQuery(this).css('display','none'); });
			panel_body.siblings('.gdl-default-post-right-sidebar').slideUp(function(){ jQuery(this).css('display','none'); });
		}		
	})
