	...
	*/
	...
	$goodlayers_menu = array(			
		...
		__('Overall Elements', 'gdl_back_office') => array(
			...
			__('Twitter / Copyright', 'gdl_back_office')=>'gdl_panel_copyright_area'),
		...
		__('Elements Color', 'gdl_back_office') => array(
			...
			__('Sidebar / Bottom Twitter', 'gdl_back_office')=>'gdl_panel_sidebar_color',
	...
	$goodlayers_element = array(
		...
		'gdl_panel_page_style' => array(
			__('ENABLE BOXED STYLE', 'gdl_back_office')=>array(
				'type'=>'radioenabled',
				'name'=>THEME_SHORT_NAME.'_enable_boxed_style'
			),		
		...
		'gdl_panel_font_size' => array(
			__('NAVIGATION SIZE', 'gdl_back_office')=>array('type'=>'sliderbar','name'=>THEME_SHORT_NAME.'_navigation_size','default'=>'13',
			...
			__('WIDGET TITLE SIZE', 'gdl_back_office')=>array('type'=>'sliderbar','name'=>THEME_SHORT_NAME.'_widget_title_size','default'=>'15',
		...
		'gdl_panel_font' => array(
			__('HEADER FONT', 'gdl_back_office')=>array('type'=>'font-combobox','name'=>THEME_SHORT_NAME.'_header_font', 'default'=>'- ABeeZee',
			...
			__('MAIN NAVIGATION FONT', 'gdl_back_office')=>array('type'=>'font-combobox','name'=>THEME_SHORT_NAME.'_navigation_font', 'default'=>'- ABeeZee'),
			__('SLIDER TITLE FONT', 'gdl_back_office')=>array('type'=>'font-combobox','name'=>THEME_SHORT_NAME.'_slider_title_font', 'default'=>'- ABeeZee'),
			__('CONTENT FONT', 'gdl_back_office')=>array('type'=>'font-combobox','name'=>THEME_SHORT_NAME.'_content_font', 'default'=>'- PT Sans',
				'description'=>'Choose the font to use with content. CUFON are not allowed to use with the content font.'),
			__('STUNNING TEXT FONT', 'gdl_back_office')=>array('type'=>'font-combobox','name'=>THEME_SHORT_NAME.'_stunning_text_font', 'default'=>'- ABeeZee',
		...
		'gdl_panel_logo' => array( 
			...
			__('LOGO TOP MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_logo_top_margin','default'=>'50',
				'description'=>'Input number to set the top space of the logo. Negative value is allowed. Please use -0 instead of 0.'), 
			__('LOGO BOTTOM MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_logo_bottom_margin','default'=>'42',
				'description'=>'Input number to set the bottom space of the logo. Negative value is allowed. Please use -0 instead of 0.'),
			__('LOGO RIGHT TEXT', 'gdl_back_office')=>array('type'=>'textarea','name'=>THEME_SHORT_NAME.'_logo_right_text',
			...
			__('LOGO RIGHT TEXT TOP MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_logo_right_text_top_margin', 'default'=>'40'),
		...
		'gdl_panel_background' => array(
			...
			__('CONTENT SHADOW OPACITY', 'gdl_back_office')=>array( 'type'=>'inputtext', 'name'=>THEME_SHORT_NAME.'_content_shadow_opacity', 'default'=>'0.4', 
				'description'=>'Value can be varied from 0 to 1. ( Only available when box style option is on )'),						
		),
		...
		'gdl_panel_icon_style' => array(
			...
			__('BOTTOM TWITTER ICON STYLE', 'gdl_back_office')=>array('type'=>'combobox','name'=>THEME_SHORT_NAME.'_twitter_icon_type','options'=>array('0'=>'light','1'=>'dark'),'default'=>'light',
				'description' =>'There are two icon types in this theme, dark and light, you can choose it to display on the twitter at the bottom of the page as you want.'),
		...
		'gdl_panel_copyright_area' => array( 
			...
			__('CONSUMER ID', 'gdl_back_office')=>array('type'=>'inputtext', 'name'=> THEME_SHORT_NAME.'_twitter_bar_consumer_id'),		
		...
		'gdl_panel_header_navigation' => array(
			__('TOP BAR BACKGROUND', 'gdl_back_office')=>array( 'type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_bar_background',
				'default'=>'#1bc4de', 'attr'=> array('background-color'), 'selector'=>'.top-navigation-wrapper' ),
			__('SEARCH TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_search_text',
				'default'=>'#cccccc', 'attr'=> array('color'), 'selector'=>'div.top-search-wrapper input[type="text"]' ),
			__('SEARCH TEXT BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_search_background',
				'default'=>'#f3f3f3', 'attr'=> array('background-color'), 'selector'=>'div.top-search-wrapper input[type="text"]' ),
			__('SEARCH BUTTON BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_top_search_button_border',
				'default'=>'#dbdbdb', 'attr'=> array('border-color'), 'selector'=>'div.top-search-wrapper input[type="submit"]' ),				
			...
			__('MAIN NAVIGATION BACKGROUND HOVER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_background_hover',
				'default'=>'#1bc4de', 'attr'=> array('background-color'),  'selector'=>'.sf-menu li a:hover'),				
			__('MAIN NAVIGATION TEXT CURRENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_text_current',
				'default'=>'#ffffff', 'attr'=> array('color'), 'selector'=>'.sf-menu li.current-menu-ancestor a, .sf-menu li.current-menu-item a, .sf-menu li.current-post-ancestor a',
				'description'=>'This is the text color of the main navigation in "current page" state.'),				
			__('MAIN NAVIGATION TEXT CURRENT BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_text_current_bg',
				'default'=>'#1bc4de', 'attr'=> array('background-color'), 'selector'=>'.sf-menu li.current-menu-ancestor a, .sf-menu li.current-menu-item a, .sf-menu li.current-post-ancestor a',
				'description'=>'This is the background color of the main navigation item in "current page" state.'),
			...
			__('SUB NAVIGATION TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_text',
				...
				'selector'=>'.sf-menu li li a, .sf-menu li.current-menu-item li a, .sf-menu li.current-menu-ancestor li a, .sf-menu li li.current-menu-item li a, .sf-menu li.current-post-ancestor li a' ),
			...
			__('SUB NAVIGATION TEXT CURRENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_text_current',
				'default'=>'#3d3d3d', 'attr'=> array('color'), 
				'selector'=>'.sf-menu li li.current-menu-item a, .sf-menu li li.current-menu-ancestor a, .sf-menu li li.current-menu-ancestor li.current-menu-item a, .sf-menu li li.current-post-ancestor a' ),
		),		
		
		'gdl_panel_body' => array(	
			__('PAGE HEADER TITLE TOP BAR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_top_bar',
				'default'=>'#e5e5e5', 'attr'=>array('background-color'), 'selector'=>'div.page-header-top-gimmick'),		
			__('PAGE HEADER TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_title_color',
				'default'=>'#4a4a4a', 'attr'=>array('color'), 'selector'=>'h1.page-header-title'),	
			__('PAGE HEADER CAPTION', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_header_caption',
				'default'=>'#b6b6b6', 'attr'=>array('color'), 'selector'=>'span.page-header-caption'),				
			__('TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_title_color',
				'default'=>'#4a4a4a', 'attr'=>array('color'), 'selector'=>'h1, h2, h3, h4, h5, h6',
			...
			__('CONTENT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_content_color',
				'default'=>'#959595', 'attr'=>array('color'), 'selector'=>'body'),
			__('BODY BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_body_background',
				'default'=>'#555555', 'attr'=>array('background-color'), 'selector'=>'html',
			...
			__('LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_link_color',
				'default'=>'#1bc4de', 'attr'=>array('color'), 'selector'=>'a',
			...
			__('LINK HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_link_hover_color',
				'default'=>'#a5e5ee', 'attr'=>array('color'), 'selector'=>'a:hover',
		...
		'gdl_panel_sidebar_color' => array(
			__('SIDEBAR LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_link_color',
				'default'=>'#969696', 'attr'=>array('color'), 'selector'=>'.sidebar-wrapper a' ),
			__('SIDEBAR LINK HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_link_hover_color',
				'default'=>'#d1d1d1', 'attr'=>array('color'), 'selector'=>'.sidebar-wrapper a:hover' ),
			...
			__('SIDEBAR INFO COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_info_color',
				'default'=>'#cacaca', 'attr'=>array('color'), 'selector'=>'.sidebar-wrapper .recent-post-widget-info, .sidebar-wrapper #twitter_update_list' ),				
			...
			__('TWITTER BAR BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_twitter_bar_background',
				'default'=>'#1bc4de', 'attr'=>array('background-color'), 'selector'=>'div.footer-twitter-wrapper'),		
			__('TWITTER BAR TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_twitter_bar_text',
				'default'=>'#ffffff', 'attr'=>array('color'), 'selector'=>'div.footer-twitter-wrapper'),		
			__('TWITTER BAR LINK', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_twitter_bar_link',
				'default'=>'#ffffff', 'attr'=>array('color'), 'selector'=>'div.footer-twitter-wrapper a'),					
		),
		
		'gdl_panel_footer' => array(	
			__('FOOTER TOP BAR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_top_bar',
				'default'=>'#eaeaea', 'attr'=>array('background-color'), 'selector'=>'div.footer-top-bar',
			...
			__('FOOTER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_background',
				'default'=>'#3a3a3a', 'attr'=>array('background-color'), 'selector'=>'div.footer-wrapper'),
			...
			__('FOOTER INPUT BOX TEXT', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_input_text', 
				'default'=>'#474747', 'attr'=>array('color'), 
		...
		'gdl_panel_slider' => array(
			...
			__('SLIDER TITLE BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_title_background',
				'default'=>'#1bc4de', 'attr'=>array('background-color'), 'selector'=>'h2.gdl-slider-title'),
			...
			__('SLIDER BULLET BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_bullet_background',
				'default'=>'#1bc4de', 'attr'=>array('background'), 
			...
			__('SLIDER NAVIGATION BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_navigation_background',
				'default'=>'#1bc4de', 'attr'=>array('background-color'), 
				'selector'=>'.ls-bluediamond .ls-nav-prev, .ls-bluediamond .ls-nav-next,' . 
			...
			__('SLIDER NAVIGATION HOVER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_navigation_active_background',
				'default'=>'#333333', 'attr'=>array('background-color'), 
				'selector'=>'.ls-bluediamond .ls-nav-prev:hover, .ls-bluediamond .ls-nav-next:hover, ' . 
							'div.gdl-top-slider .flex-direction-nav li .flex-prev:hover, div.gdl-top-slider .flex-direction-nav li .flex-next:hover, ' . 
							'div.gdl-top-slider .nivo-directionNav a.nivo-prevNav:hover, div.gdl-top-slider .nivo-directionNav a.nivo-nextNav:hover,' .
							'div.anythingSlider .arrow.back:hover, div.anythingSlider .arrow.forward:hover'),						
			...
			__('STUNNING TEXT TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_stunning_text_title_color',
				'default'=>'#5a5a5a', 'attr'=>array('color'), 'selector'=>'h1.stunning-text-title' ),
			__('STUNNING TEXT CAPTION COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_stunning_text_caption_color',
				'default'=>'#9c9c9c', 'attr'=>array('color'), 'selector'=>'.stunning-text-caption'),
			__('STUNNING TEXT BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_stunning_text_background_color',
				'default'=>'#ffffff', 'attr'=>array('background-color'), 'selector'=>'.stunning-text-wrapper'),		
		),
		...
		'gdl_panel_blog_pagination' => array(			
			__('BLOG TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_title_color',
				'default'=>'#4a4a4a', 'attr'=>array('color'), 'selector'=>'h2.blog-title a, h1.blog-title a, div.portfolio-item .page-item-title a' ),
			...
			__('BLOG DATE TOP BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_date_top_border',
				'default'=>'#e3e3e3', 'attr'=>array('border-color'), 'selector'=>'div.blog-date-wrapper'),
			__('BLOG WIDGET DATE TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_date_widget_text',
				'default'=>'#a6a6a6', 'attr'=>array('color'), 'selector'=>'div.blog-date-widget-wrapper'),
			__('BLOG FULL DATE TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_date_text',
				'default'=>'#4e4e4e', 'attr'=>array('color'), 'selector'=>'div.blog-date-wrapper'),				
			__('BLOG INFO COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_info_color',
				'default'=>'#666666', 'attr'=>array('color'), 'selector'=>'div.blog-info-wrapper a'),
			__('BLOG INFO TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_info_title_color',
				'default'=>'#a6a6a6', 'attr'=>array('color'), 'selector'=>'div.blog-info-wrapper'),				
			...
			__('PAGINATION HOVER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_pagination_hover_background',
				'default'=>'#1bc4de', 'attr'=>array('background-color'), 'selector'=>'div.gdl-pagination a:hover'),
			...
			__('PAGINATION CURRENT BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_pagination_current_background',
				'default'=>'#1bc4de', 'attr'=>array('background-color'), 'selector'=>'div.gdl-pagination span'),
		...
		'gdl_panel_portfolio' => array(
			__('THUMBNAIL HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_thumbnail_hover_color',
				'default'=>'#39cce2', 'attr'=>array('background-color'), 'selector'=>'div.portfolio-media-wrapper span.portfolio-thumbnail-image-hover'),		
			__('PORT TITLE BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_title_background',
				'default'=>'#f6f6f6', 'attr'=>array('background-color'), 'selector'=>'.portfolio-item .portfolio-context'),
			__('PORT TITLE BACKGROUND HOVER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_title_background_hover',
				'default'=>'#343434', 'attr'=>array('background-color'), 'selector'=>'.portfolio-item .portfolio-context:hover'),				
			__('PORT TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_title_color',
				'default'=>'#5b5b5b', 'attr'=>array('color'), 'selector'=>'.portfolio-item .portfolio-context .portfolio-title a',
			...
			__('PORT TITLE HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_title_hover_color',
				'default'=>'#ffffff', 'attr'=>array('color'), 'selector'=>'.portfolio-item .portfolio-context:hover .portfolio-title a'),
			__('PORT TAG COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_tag_color',
				'default'=>'#aaaaaa', 'attr'=>array('color'), 'selector'=>'.portfolio-item .portfolio-context .portfolio-tag, .portfolio-item .portfolio-context .portfolio-tag a'),	
			__('PORT TAG HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_tag_hover_color',
				'default'=>'#aaaaaa', 'attr'=>array('color'), 'selector'=>'.portfolio-item .portfolio-context:hover .portfolio-tag, .portfolio-item .portfolio-context:hover .portfolio-tag a'),				
		...
		'gdl_panel_price_personnal_item' => array(
			...
			__('PRICE TAG ACTIVE COLOR', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_price_tag_active_color', 
				'default'=>'#ffffff', 'attr'=>array('color'), 'selector'=>'div.best-price .price-tag, div.best-price .price-tag .price-suffix'),				
			__('PRICE TAG ACTIVE BACKGROUND', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_price_tag_active_background', 
				'default'=>'#1bc4de', 'attr'=>array('background-color'), 'selector'=>'div.best-price .price-tag'),
			__('PRICE ACTIVE TOP BORDER', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_price_active_border', 
				'default'=>'#1bc4de', 'attr'=>array('border-top-color', 'border-bottom-color'), 'selector'=>'div.best-active'),			
			__('PRICE ACTIVE BUTTON BACKGROUND', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_price_active_button_background', 
				'default'=>'#1bc4de', 'attr'=>array('background-color'), 'selector'=>'div.price-item .price-button'),				
			...
			__('PERSONNAL THUMBNAIL BORDER', 'gdl_back_office') => array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_personnal_thumbnail_border', 
				'default'=>'#1bc4de', 'attr'=>array('border-color'), 'selector'=>'div.personnal-item .personnal-thumbnail'),
		...
		'gdl_panel_additional_elements' => array(				
			...
			__('BUTTON BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_button_background_color',
				'default'=>'#1bc4de', 'attr'=>array('background-color'), 'selector'=>'a.gdl-button, body button, input[type="submit"], input[type="reset"], input[type="button"]'),					
			...
			__('COLUMN SERVICE TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_column_service2_title_color',
				'default'=>'#4a4a4a', 'attr'=>array('color'), 'selector'=>'h2.column-service-title'),				
		),
		...
		'gdl_panel_additional_elements_2' => array(
			...
			__('TAB ACTIVE TITLE BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_tab_active_title_border',
				'default'=>'#1bc4de', 'attr'=>array('border-top-color'), 'selector'=>'div.gdl-tab ul.gdl-tab-title li a.active' ),	
			...
			__('TESTIMONIAL (STATIC) CONTENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_testimonial_static_content_color',
				'default'=>'#666666', 'attr'=>array('color'), 'selector'=>'div.gdl-static-testimonial .testimonial-item'),
			__('TESTIMONIAL (STATIC) BORDER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_testimonial_static_border',
				'default'=>'#bdbdbd', 'attr'=>array('border-color'), 'selector'=>'div.gdl-static-testimonial .testimonial-item'),
			__('TESTIMONIAL (STATIC) INFO', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_testimonial_static_info',
				'default'=>'#a8a8a8', 'attr'=>array('color'), 'selector'=>'div.gdl-static-testimonial .testimonial-info'),				
		),
